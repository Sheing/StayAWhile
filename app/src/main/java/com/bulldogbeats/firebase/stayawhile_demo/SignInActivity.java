...
import com.bulldogbeats.firebase.stayawhile_demo.utility.PasswordResetDialog;
import com.bulldogbeats.firebase.stayawhile_demo.utility.ResendVerificationDialog;
import com.bulldogbeats.firebase.stayawhile_demo.utility.UniversalImageLoader;
import com.bulldogbeats.firebase.stayawhile_demo.viewholder.RegisterActivity;
...
/*
    ...
    public boolean servicesOK(){
        ...
        int isAvailable = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(SignInActivity.this);
        ...
        if(isAvailable == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(SignInActivity.this, isAvailable, ERROR_DIALOG_REQUEST);
            dialog.show();
        }
        else{
...
*/
   ...
   /* private void initImageLoader(){
        UniversalImageLoader imageLoader = new UniversalImageLoader(SignInActivity.this);
