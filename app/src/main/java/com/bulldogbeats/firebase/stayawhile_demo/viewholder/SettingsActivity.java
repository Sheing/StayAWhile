...
import com.bulldogbeats.firebase.stayawhile_demo.utility.ChangePhotoDialog;
import com.bulldogbeats.firebase.stayawhile_demo.utility.FilePaths;
...
public class SettingsActivity extends AppCompatActivity implements
    ...
    private void init(){
        ...
        mProfileImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d(TAG, "onClick: Changing Profile Image");
    ...
    private void setCurrentEmail(){
        ...
        if(user != null){
           ...
           /* Log.d(TAG, "setCurrentEmail: got the email: " + email);
            ...
            mPhone.setText(user.getPhone());
            Log.d(TAG, "ondatachange:"+user.getPhone());
            ImageLoader.getInstance().displayImage(user.getProfile_image(), mProfileImage);*/
